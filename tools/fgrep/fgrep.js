 ...
 */
/* globals fetch, alert, DOMParser */

const SITEMAP = '/hub/sitemap.xml';
const OWNER = 'adobe';
const REPO = 'fedpub';
const REF = 'main';
...
async function edit(path, y) {
    try {
        const statusRes = await fetch(`https://admin.hlx.page/status/${OWNER}/${REPO}/${REF}${path}?editUrl=auto`);
