...
export default async function loadPromotion(block, name, document, callback) {
    const { locale } = window.fedPub;
    const promotionName = block.getAttribute('data-promotion');
    ...
    block.appendChild(document.createRange()
